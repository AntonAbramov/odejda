...
router.get('/', function (req, res, next) {
  res.render('index', {
    ...
    description: "Ателье - Odejda-ua предоставляет широкий спектр услуг по пошиву одежды. Пошив оптом | Индивидуальный пошив | Ремонт Одежды.",
    keywords: "пошив одежды Харьков, швейный цех Харьков, ремонт одежды, одежда оптом Харьков, поставщики одежды, швейное производство, швейное ателье",
  });
});
